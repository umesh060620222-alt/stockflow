        ...
        if stage == 3:
            ...
            if high >= bounce_level:
                ...
                if is_valid_time and is_valid_vol and is_nifty_bullish:
                    ...
                    # Trailing Breakeven logic variables
                    ...
                    for idx_w, w in enumerate(candles[i+1:], start=i+1):
                        ...
                        # Check if price has gone halfway to target (0.5x of target gap)
                    ...
                    if trade_result == "WIN":
                        ...
                        pnl_pct = 0.0 - FRICTION # Lose only friction on breakeven
                    else:
                        pnl_pct = 0.0
...
def run_test():
    ...
    for d in test_dates:
        ...
        print("\n" + "="*95)
        print(f"SESSION SUMMARY FOR DATE: {d} (WITH NIFTY 15-EMA & TRAILING BREAKEVEN)")
        print("="*95)
        win_rate = (wins / (wins + losses) * 100) if (wins + losses) > 0 else 0.0
        print(f"Wins: {wins} | Losses: {losses} | Breakeven: {be} | Open: {opens} | Win Rate (excl. BE): {win_rate:.1f}%")
