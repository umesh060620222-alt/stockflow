...
def main():
    print("Downloading historical 1m data for the last 7 calendar days (5 trading days)...")
    ...
    # Process Nifty EMA for all dates
    ...
    print("\n" + "="*85)
    print(f"{'DATE':<15}{'WINS':>8}{'LOSSES':>10}{'B/EVEN':>10}{'WIN RATE%':>12}{'NET PnL (INR)':>18}")
    print("-"*85)
    for s in daily_summaries:
        print(f"{s['date']:<15}{s['wins']:>8}{s['losses']:>10}{s['be']:>10}{s['win_rate']:>12.1f}%{s['pnl']:>18,.0f} INR")
    print("="*85)
    print(f"CUMULATIVE 5-DAY NET PROFIT: {cumulative_pnl:,.0f} INR")
    print("="*85)
