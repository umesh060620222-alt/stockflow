...
def main():
    ...
    print("\n" + "="*95)
    print(f"{'SYMBOL':<15}{'ENTRY TIME':<12}{'ENTRY PRICE':>12}{'SHARES BOUGHT':>15}{'RESULT':<12}{'EXIT PRICE':>12}")
    print("-"*95)
    
    for t in all_trades:
        sym_clean = t["sym"].replace(".NS", "")
        shares = 100000 / t["entry"]
        exit_str = f"{t['exit']:.2f}" if t["exit"] else "-"
        print(f"{sym_clean:<15}{t['entry_time']:<12}{t['entry']:>12.2f}{shares:>15.1f}{t['result']:<12}{exit_str:>12}")
    print("="*95)
