...
USE_NIFTY_FILTER = False     # atr_pullback: check if Nifty is green today
...
max_entry_gap_points = 25.0 # max points difference allowed between signal spot and actual fill spot
