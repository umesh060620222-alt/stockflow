...
def run_90_day_10am_backtest():
    ...
    # We test the last 90 trading days of this list
    test_days = trading_days[-90:]
    
    print("\n" + "="*95)
    print("📊 10:00 AM GAP RULE 90-DAY BACKTEST REPORT")
    print("="*95)
    ...
    for i, day in enumerate(test_days):
        ...
        # We only print the summary rows if there's a trade to keep VM console output clean, 
        # but we will print all 90 rows to let the user see the history.
