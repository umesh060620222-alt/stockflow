...
def reconstruct_pcr():
    ...
    # Fetch NFO instruments cache to resolve tokens
    ...
    # Dictionary to hold volume data series for each contract
    vol_data = {}
    ...
    # Calculate a 15-period rolling EMA (matching the 30s-1m EMA used in the bot)
    ...
    print("\n" + "="*80)
    print(f"📊 TODAY'S VOLUME PCR EXTREMES REPORT ({today})")
    print("="*80)
